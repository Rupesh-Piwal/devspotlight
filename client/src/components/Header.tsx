    ...
    <header className="shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          <Link
            to="/dashboard"
            className="text-[20px] md:text-[26px] font-bold text-transparent bg-clip-text bg-gradient-to-tr from-[#FFA05C] to-[#F06500]"
          >
            DevSpotLight
          </Link>
          <div className="flex items-center space-x-4">
            ...
            <Button className="bg-gradient-to-tr from-[#FFA05C] to-[#F06500] hover:opacity-70 text-center">
              <PlusCircle />
